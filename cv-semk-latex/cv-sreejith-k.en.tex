...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Frameworks}: Pylons, web2py, Tornado, Flask, Bottle, webpy, PyQt.
  ...
  Perforce.
  \citembullet {\it Virtualization Platforms}: Xen, OpenVZ, KVM, VMware ESX(i).
...
%% \begin{category}{Organizations}
%%  \citem Member of the {\em Python Software Society of India}.
%% \end{category}
